...
<div class="block">
	<!-- start of header -->
	<table width="100%" style="background-color: #f5f5f5;" bgcolor="#f5f5f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
		<tbody>
		<tr>
			<td>
				<table width="650" style="background-color: #f5f5f5;" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
					<tbody>
					<tr>
						<td>
							<!-- logo -->
									...
									<td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
										<div class="imgpop">
											<a href="{{ action('PageController@index') }}">
												<img src="{{ URL::asset('img/EIS_logo_text.gif') }}" alt="logo" border="0" width="200" style="display:block;margin: 0 auto; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo">
											</a>
										</div>
									</td>
								</tr>
