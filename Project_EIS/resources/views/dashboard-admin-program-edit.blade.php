...
@section('content')
    ...
    <div class="col-md-9">
        <div class="well">
            <h1>Edit Program</h1>
            <hr>
            {!! Form::model($program, ['method' => 'PATCH','action' => ['ProgramController@update',$program->id],'enctype' => 'multipart/form-data']) !!}
            @include('partials._program-form')
            {!! Form::close() !!}
        </div>
        <div class="well">
            <h1>Program Thumbnail</h1>
            <hr>
            <div class="thumbnails-program">
                <div class="row">
                    @foreach($program->thumbnails as $thumbnail)
                        <div class="col-lg-4">
                            <div class="thumbnails-box">
                                <img src="{{ action('AttachmentController@get',$thumbnail->hashcode)}}" alt="Thumbnail">
                            </div>
                            <div class="control">
                                {!! Form::open(['action' => ['AttachmentController@delete',$thumbnail->hashcode],'method' => 'DELETE']) !!}
